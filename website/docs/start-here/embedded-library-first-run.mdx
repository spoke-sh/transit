...
That is the default human proof path. It builds the workspace and runs the local engine, tiered history, server, integrity, and materialization proofs in one flow.
