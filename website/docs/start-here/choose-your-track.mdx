...
- [System Model](../foundations/system-model.mdx)
...
This site now ships both the public onramp and the core foundations. When you want the model behind the narrative pages, continue into [Foundations](../foundations/system-model.mdx).
