...
This site now ships both the public onramp and the canonical contract set. When you want the repo terms behind the narrative pages, continue into [Foundations](../foundations/system-model.mdx).
