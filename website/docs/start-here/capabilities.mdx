...
This is immutable segment compression only. It does not compress individual
record payloads, and it does not compress hosted request or response envelopes.
